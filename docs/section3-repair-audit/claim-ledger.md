...
| G-14 | P | Archived prior publication runs, paper, prior release assets, and reproducibility terminal programs remain unchanged; current imported result trees match their selected clean-run manifest. | Path-set equality contract | Base-to-worktree byte/hash comparison | `BLOCKED` |
