      ...
      <div className="toolbar-popover-anchor">
        ...
        {filtersOpen && (
          <div className="graph-filter-popover">
            ...
            <label><input type="checkbox" checked={filters.showCrossLinks} onChange={(event) => onFilterChange("showCrossLinks", event.target.checked)} />Show structural cross-links</label>
