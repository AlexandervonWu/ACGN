...
public final class LawRecordWireExtractor {
    ...
    private static final Map<String, String> OWNERS = Map.of(
            ...
            "AlloyLawRegistry", P + "AlloyLawRegistry", "ContainerLawCertificate", P + "ContainerLawCertificate",
            "CertificateOrigin", P + "CertificateOrigin");
    ...
    private static String resolved(ClassTree node, CompilationUnitTree unit, Trees trees) {
        ...
        new TreeScanner<Void, Void>() {
            private void bind(Tree tree) {
                ...
                require(element != null, "unresolved law-record symbol");
    ...
    public static void main(String[] args) throws Exception {
        require(args.length == 2, "Usage: LawRecordWireExtractor ROOT OUTPUT.tsv");
        ...
        require(errors.isEmpty(), "law-record shape/binding mismatch\n" + String.join("\n", errors));
        require(rows.size() == 11, "incomplete source census");
        Files.write(output, rows, StandardCharsets.UTF_8);
        System.out.println("LawRecordWireExtractor passed: objects=10");
    }
}
